...
namespace Tu_Tu.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [AllowAnonymous]
        [Route("login")]
        public async Task<IHttpActionResult> LoginUser(UserModel model)
        {
            if (model == null)
            {
            ...
            var tokenServiceResponse = await testServer.HttpClient.PostAsync(
                "http://localhost:64759/Token", requestParamsFormUrlEncoded);
        ...
        /// <summary>
        /// Check the avilability of user name
        /// </summary>
        ...
        [HttpGet]
        [Route("CheckUserName")]
        public async Task<bool> CheckAvailabilityForName(string userName)
        {
            ...
            bool result = await _repo.FindByNameAsync(userName);

            return result;
        }

        /// <summary>
        /// Check the avilability of email
        /// </summary>
        ...
        [HttpGet]
        [Route("CheckEmail")]
        public async Task<bool> CheckAvailabilityForEmail(string email)
            {
            ...
            bool result = await _repo.FindUserByEmail(email);
        ...
        private string ValidateClientAndRedirectUri(HttpRequestMessage request, ref string redirectUriOutput)
        {
            ...
            var client = _repo.FindUser(clientId,null);
